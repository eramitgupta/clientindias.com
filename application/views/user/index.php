                            ...
                            <div class="col-lg-4">
                                <div class="card bg-primary text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h4 class="text-white">Today's Income Total</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card bg-success text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h4 class="text-white">Last 7 Days Income Total</h4>
                            ...
                            <div class="col-lg-4">
                                <div class="card bg-info text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h4 class="text-white">Last 30 Days Income Total</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card bg-warning text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h4 class="text-white">My Income Total</h4>
                                    </div>
                                </div>
                            </div>
