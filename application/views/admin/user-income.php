                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr id="<?= $row['id'] ?>">
                                                            ...
                                                            <td><?= $row['date'] ?></td>
                                                            <td>
                                                                <button type="button" id="<?= $row['id'] ?>" value="<?= $row['wallet_money'] ?>" name="<?= $row['name'] ?>" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable" class="btn btn-primary user_income_view">
                                                                    <i class="fas fa-eye user_income_view" id="<?= $row['id'] ?>" value="<?= $row['wallet_money'] ?>" name="<?= $row['name'] ?>"></i>
                                                                </button>

                                                                <button type="button" id="<?= $row['id'] ?>" value="<?= $row['wallet_money'] ?>" name="<?= $row['name'] ?>" data-bs-toggle="modal" data-bs-target="#PayModalScrollable" class="btn btn-warning user_income_pay">
                                                                    <i class="fas fa-money-check-alt user_income_pay" id="<?= $row['id'] ?>" value="<?= $row['wallet_money'] ?>" name="<?= $row['name'] ?>"></i>
                                                                </button>
                                                            </td>
            ...
            <div class="modal-body">
                <center>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" id="summary1" name="" data-name="" class="btn btn-primary user_income_view_summary" value="1 Day">Today</button>
                        <button type="button" id="summary2" name=""  data-name="" class="btn btn-warning user_income_view_summary" value="7 Day">7 Day</button>
                        <button type="button" id="summary3" name="" data-name="" class="btn btn-success user_income_view_summary" value="30 Day">30 Day</button>
                    </div>
                </center>
                <br>
                <table class="table">
            ...
            <div class="modal-body">
                <form id="FormData" method="post">
                    <div class="row">
                        ...
                        <div>
                            <center><button type="button" id="PayUserSend" name="PayUserSend" class="btn btn-primary mt-2">Submit</button></center>
                        </div>
