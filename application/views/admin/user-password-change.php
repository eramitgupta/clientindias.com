                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="FormData">
                                    ...
                                    <input type="hidden" name="id" value="<?= set_value('id',$AccountArray['id']); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="password" id="password" placeholder="Enter Your Password" onKeyUp="checkPasswordStrength();">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div>
                                        <center><button type="button" id="UserPasswordUpdate" class="btn btn-primary w-md mt-3">Update Account </button></center>
                                    </div>
                                </form>
                            </div>
                            <!-- end card body -->
