            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="text-center">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <p class="mb-5">Please enter the 4 digit code sent to
                                        <br>
                                        <a href="<?= base_url('login/AccountotSession'); ?>">Change your account</a>
                                    </p>
                                    <form method="post" id="FormData">
                                        <div class="row" id="otpVerificationRow">
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" id="email" name="email" value="<?= $this->session->userdata('account_verification')['email'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <span id="timer"></span>
                                        <div class="mt-4">
                                            <button type="button" name="AccountotpVerification" id="AccountotpVerification" class="btn btn-primary w-md">Confirm</button>
                                            <button type="button" class="btn btn-success w-md" id="Accountresent" name="Accountresent">Resent</button>
                                        </div>
                                    </form>
                                </div>
                ...
                <script>
                    ...
                    function timer(remaining) {
                        ...
                        $("#Accountresent").removeAttr("disabled", "disabled");
                    }
                    timer(120);
                </script>
