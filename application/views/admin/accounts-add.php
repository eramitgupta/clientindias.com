            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/authentication/account_add'); ?>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="referral_code" name="referral_code" placeholder="Enter Referral Code (option)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div>
                                        <center><button type="submit" class="btn btn-primary w-md mt-3 mb-3">Submit </button></center>
                                    </div>
                                </form>
                            </div>
                            <!-- end card body -->
