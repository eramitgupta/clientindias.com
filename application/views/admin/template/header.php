        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="<?= base_url('admin/authentication/') ?>accounts-edit/<?= $this->session->userdata('Login_Auth')['id']; ?>"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
                    <div class="dropdown-divider"></div>

                    <a class="dropdown-item" href="<?= base_url('admin/authentication/') ?>password-change/<?= $this->session->userdata('Login_Auth')['id']; ?>">
                        <i class="bx bx-key font-size-16 align-middle me-1"></i> <span key="t-logout">Password Change</span></a>
