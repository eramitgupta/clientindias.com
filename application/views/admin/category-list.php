                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr id="<?= $row['id'] ?>">
                                                                <th><?= $x ?></th>
                                                                <th>
                                                                    <img src="<?= base_url('uploads/category/' . $row['icon']) ?>" alt="" style="height: 50px;">
                                                                </th>
                                                                <th><?= $row['name'] ?></th>
                                                                <td>
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    <a href="<?= base_url('admin/category/statusUpdate?id=' . $row['id'] . '&status=' . $row['status']) ?>" class="btn btn-<?= $color; ?> btn-rounded waves-effect waves-light"><?= $status ?></a>
                                                                </td>
                                                                <td>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger CategoryDelete" id="CategoryDelete">
