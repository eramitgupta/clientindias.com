                                                        ...
                                                        ?>
                                                            <tr id="<?= $row['pay_id'] ?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <a href="<?= $row['pay_status'] == 'Active' ? 'javascript:void(0)' : base_url('admin/transaction/status?id=' . $row['pay_id'] . '&status=' . $row['pay_status'] . '&user_id=' . $row['Login_id'] . '&commission=' . $row['commission'] . '&referral_code=' . $row['referral_code'])  ?>" class="btn btn-<?= $color; ?> btn-rounded waves-effect waves-light"><?= $status ?></a>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    <a href="<?= base_url('admin/transaction/statusUpdate?id=' . $row['pay_id'] . '&status=' . $row['p_r_status']) ?>" class="btn btn-<?= $color; ?> btn-rounded waves-effect waves-light"><?= $status ?></a>
                                                                </td>
                                                                <th><?= $row['pay_date'] ?></th>
                                                            <?php $x++;
                                                        } ?>
