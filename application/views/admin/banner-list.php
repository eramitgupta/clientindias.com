                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                <table id="datatable-buttons" class="table table-bordered  dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php
                                        $x = 1;
                                        foreach ($ArrayBanner as $row) {
                                        ?>
                                            <tr id="<?= $row['id'] ?>">
                                                <th><?= $x ?></th>
                                                <th>
                                                    <img src="<?= base_url('uploads/banner/' . $row['banner']) ?>" alt="" style="height: 50px;">
                                                </th>
                                                <th><?= $row['link'] ?></th>
                                                <td>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <a href="<?= base_url('admin/banner/status?id=' . $row['id'] . '&status=' . $row['status']) ?>" class="btn btn-<?= $color; ?> btn-rounded waves-effect waves-light"><?= $status ?></a>
                                                </td>
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <button type="button" class="btn btn-danger BannerDelete" id="BannerDelete">
