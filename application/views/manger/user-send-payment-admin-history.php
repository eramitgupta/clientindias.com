                                                            ...
                                                            <tr id="<?= $row['Pay_ID'] ?>">
                                                                ...
                                                                <th>
                                                                    <div class="popup-gallery d-flex flex-wrap">
                                                                        <a href="<?= base_url('uploads/payment/' . $row['screenshot']) ?>" title="<?= $row['name'] ?>, Transaction NO <?= $row['transaction_no'] ?>, Price ₹<?= $row['amount'] ?> , Date <?= $row['Pay_Date'] ?>">
